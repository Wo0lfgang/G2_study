...
function bound(bounds, item, margin) {
    ...
    var _b = __read(margin, 4), _c = _b[0], t = _c === void 0 ? 0 : _c, _d = _b[1], r = _d === void 0 ? 0 : _d, _e = _b[2], b = _e === void 0 ? t : _e, _f = _b[3], l = _f === void 0 ? r : _f;
...
export var IntersectUtils = { lineToLine: lineToLine, intersectBoxLine: intersectBoxLine, bound: bound };
export function intersect(a, b, margin) {
    var p = bound(new Bounds(), a, margin);
    var q = bound(new Bounds(), b, margin);
