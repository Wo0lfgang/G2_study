...
import { BBox, classNames, deepAssign, ifShow, normalSeriesAttr, select, styleSeparator } from '../../util';
...
export function getBBox(title, content) {
    ...
    var _b = __read(normalSeriesAttr(title.attributes.text ? spacing : 0), 4), spacingTop = _b[0], spacingRight = _b[1], spacingBottom = _b[2], spacingLeft = _b[3];
    var _c = __read(normalSeriesAttr(inset), 4), insetTop = _c[0], insetRight = _c[1], insetBottom = _c[2], insetLeft = _c[3];
...
var Title = /** @class */ (function (_super) {
    ...
    function Title(options) {
        ...
        return _super.call(this, deepAssign({}, { style: DEFAULT_TITLE_CFG }, options)) || this;
    }
    Title.prototype.getAvailableSpace = function () {
        ...
        var _c = __read(normalSeriesAttr(spacing), 4), spacingTop = _c[0], spacingRight = _c[1], spacingBottom = _c[2], spacingLeft = _c[3];
        ...
        var _e = __read(normalSeriesAttr(inset), 4), insetTop = _e[0], insetRight = _e[1], insetBottom = _e[2], insetLeft = _e[3];
    ...
    Title.prototype.render = function (attributes, container) {
        ...
        restStyle = __rest(_a, ["width", "height", "position", "spacing", "class"]);
        var _b = __read(styleSeparator(restStyle), 1), titleStyle = _b[0];
        var _c = getTitleLayout(attributes), x = _c.x, y = _c.y, textAlign = _c.textAlign, textBaseline = _c.textBaseline;
        ifShow(!!restStyle.text, container, function (group) {
            _this.title = select(group)
