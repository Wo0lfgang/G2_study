...
export interface SliderStyleProps extends GroupStyleProps, PrefixedStyle<Omit<SparklineStyleProps, 'width' | 'height'> & {
    padding?: SeriesAttr;
}, 'sparkline'>, PrefixedStyle<RectStyleProps, 'track'>, PrefixedStyle<RectStyleProps, 'selection'>, HandleStyleProps {
