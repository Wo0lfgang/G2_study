import type { DisplayObjectConfig, PathStyleProps, RectStyleProps, TextStyleProps } from '@antv/g';
import type { PrefixedStyle } from '../../types';
export interface NavigatorStyle extends Omit<RectStyleProps, 'width' | 'height'>, PrefixedStyle<PathStyleProps & {
    size?: number;
}, 'button'>, PrefixedStyle<TextStyleProps, 'pageNum'> {
}
