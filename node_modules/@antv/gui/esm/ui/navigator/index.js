...
import { BBox, classNames, deepAssign, scaleToPixel, select, styleSeparator, subObjects, TEXT_INHERITABLE_PROPS, transpose, } from '../../util';
...
var Navigator = /** @class */ (function (_super) {
    ...
    function Navigator(options) {
        var _this = _super.call(this, deepAssign({}, { style: NAVIGATOR_DEFAULT_CFG }, options)) || this;
    ...
    Navigator.prototype.goTo = function (pageNum) {
        ...
        var _c = __read(this.getFollowingPageDiff(pageNum), 2), dx = _c[0], dy = _c[1];
    ...
    Navigator.prototype.adjustControllerLayout = function () {
        ...
        var _d = __read(orient === 'horizontal' ? [-180, 0] : [-90, 90], 2), r1 = _d[0], r2 = _d[1];
    ...
    Navigator.prototype.renderController = function (container) {
        ...
        if (!visible)
            return;
        var _b = __read(subObjects(this.attributes, ['button', 'pageNum']), 2), style = _b[0], textStyle = _b[1];
        var _c = __read(styleSeparator(style), 2), _d = _c[0], groupStyle = _c[1], size = _d.size, pathStyle = __rest(_d, ["size"]);
        ...
        pageInfoGroup
            ...
            .styles(__assign(__assign({}, TEXT_INHERITABLE_PROPS), textStyle));
        this.updatePageInfo();
