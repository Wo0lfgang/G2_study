...
interface LineStyleProps extends CallbackableObject<PrefixedStyle<GLineStyleProps, 'line'>, CallbackParameter<Data>>, CallbackableObject<PrefixedStyle<PathStyleProps, 'area'>, CallbackParameter<Data>> {
    /**
     * @title 是否光滑
     * @description 折线是否光滑
     */
...
interface ColumnStyleProps extends CallbackableObject<PrefixedStyle<RectStyleProps, 'column'>, CallbackParameter<Data>> {
    /**
     * @title 是否分组
     */
    isGroup?: boolean;
...
} & LineStyleProps & ColumnStyleProps;
