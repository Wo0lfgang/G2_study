...
var Scrollbar = /** @class */ (function (_super) {
    ...
    function Scrollbar(options) {
        var _this = _super.call(this, deepMix({}, Scrollbar.defaultOptions, options)) || this;
        _this.range = [0, 1];
        /**
         * 值改变事件
         */
    ...
    Scrollbar.prototype.renderSlider = function (container) {
        ...
        var _b = __read(subObjects(this.attributes, ['track', 'thumb']), 2), trackStyle = _b[0], selectionStyle = _b[1];
        var style = __assign(__assign({ orient: orient, padding: padding, slidable: slidable, trackSize: trackSize, brushable: false, showHandle: false, values: this.getValues(), trackLength: this.trackLength, trackRadius: this.trackRadius, selectionRadius: this.thumbRadius }, superObject(trackStyle, 'track')), superObject(selectionStyle, 'selection'));
