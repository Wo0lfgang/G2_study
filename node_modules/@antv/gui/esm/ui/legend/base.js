...
export function renderTitle(container, cfg) {
    ...
    return maybeAppend(container, ".".concat(className), function () {
        if (useHTML)
            return new HTML({ className: className, style: { innerHTML: innerHTML } });
        return new Text({ className: className, style: style });
    })
