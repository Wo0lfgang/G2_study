...
export var CATEGORY_DEFAULT_OPTIONS = deepMix({}, LEGEND_BASE_DEFAULT_OPTIONS, {
    style: {
        type: 'category',
        items: [],
        maxCols: undefined,
...
export var CONTINUOUS_DEFAULT_OPTIONS = deepMix({}, LEGEND_BASE_DEFAULT_OPTIONS, superObject(DEFAULT_HANDLE_CFG, 'handle'), {
    style: {
        type: 'continuous',
        color: [
            '#d0e3fa',
