...
export type PoptipPosition = 'top' | 'bottom' | 'left' | 'right' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' | 'left-top' | 'left-bottom' | 'right-top' | 'right-bottom';
export interface PoptipCfg {
     ...
     */
    domStyles?: {
        [key: '.gui-poptip' | '.gui-poptip-arrow' | '.gui-poptip-text' | string]: {
            [key: string]: string;
        };
    };
}
