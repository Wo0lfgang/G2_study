...
var Text = /** @class */ (function (_super) {
    ...
    function Text(options) {
        var _this = _super.call(this, (0, util_2.deepAssign)({}, Text.defaultOptions, options)) || this;
        _this.init();
        return _this;
    }
    Object.defineProperty(Text.prototype, "textWidth", {
        ...
        get: function () {
            var _this = this;
            return (0, util_1.max)(this.renderText.split('\n').map(function (text) { return (0, util_2.measureTextWidth)(text, _this.font); })) || 0;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Text.prototype, "textHeight", {
        get: function () {
            return (0, util_2.getShapeSpace)(this.textShape).height;
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(Text.prototype, "height", {
        ...
        get: function () {
            ...
            if ((0, util_1.isNumber)(height) && height !== 0)
                return height;
            return (0, util_2.getShapeSpace)(this.textShape).height;
        },
        enumerable: false,
        ...
        get: function () {
            ...
            return text
                ...
                return line
                    .split(' ')
                    .map(function (word) {
                    return (0, util_2.transform)(word, 'capitalize');
                })
                    .join(' ');
            })
                .join('\n');
    ...
    Object.defineProperty(Text.prototype, "text", {
        ...
        get: function () {
            ...
            return (0, util_2.transform)(text, tf);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Text.prototype, "ellipsisText", {
        get: function () {
            ...
            return text
                .split('\n')
                .map(function (line) {
                return (0, util_2.getEllipsisText)(line, (0, util_1.isNumber)(width) ? width : Infinity, _this.font, placeholder);
            })
                .join('\n');
        },
        enumerable: false,
    ...
    Object.defineProperty(Text.prototype, "renderText", {
        ...
        get: function () {
            ...
            if (overflow && !['none', 'clip', 'wrap'].includes(overflow) && (0, util_1.isNumber)(width))
    ...
    Object.defineProperty(Text.prototype, "font", {
        get: function () {
            // @ts-ignore
            return (0, util_1.pick)(this.attributes, [
                'fontSize',
                'fontFamily',
                'fontWeight',
                'fontStyle',
    ...
    Object.defineProperty(Text.prototype, "textCfg", {
        get: function () {
            ...
            return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, util_2.TEXT_INHERITABLE_PROPS), this.font), { fill: fill, wordWrap: wordWrap, lineHeight: lineHeight, wordWrapWidth: wordWrapWidth, text: renderText, textAlign: 'start', textBaseline: 'middle' });
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Text.prototype, "backgroundCfg", {
        get: function () {
            ...
            return tslib_1.__assign({ x: 0, y: 0, width: width, height: height }, backgroundStyle);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(Text.prototype, "decorationCfg", {
        get: function () {
            ...
            return this.textShape.getLineBoundingRects().map(function (bbox) {
                return (0, util_2.deepAssign)({}, { fontSize: fontSize, style: { stroke: stroke, lineWidth: lineWidth } }, decoration, bbox);
            });
        },
        enumerable: false,
        configurable: true
    ...
    Text.prototype.render = function () {
        ...
        this.decorationCfg.forEach(function (cfg) {
            _this.decorationGroup.appendChild(new decoration_1.Decoration({ style: cfg }));
        });
    };
    ...
    Text.prototype.initShape = function () {
        this.backgroundShape = new g_1.Rect({ name: 'background', style: { width: 0, height: 0 } });
        // this.decorationShape = new Decoration({ name: 'decoration' });
        this.decorationGroup = new g_1.Group({ name: 'decoration-group' });
        this.textShape = new g_1.Text({ name: 'text', style: this.textCfg });
    ...
    Text.prototype.overflow = function () {
        ...
        if (!overflow || overflow === 'none' || wordWrap || !(0, util_1.isNumber)(width))
            return;
        if (overflow === 'clip') {
            // 裁切
            this.clipRect = new g_1.Rect({ name: 'clip-rect', style: this.clipRectCfg });
