...
var Scrollbar = /** @class */ (function (_super) {
    ...
    function Scrollbar(options) {
        var _this = _super.call(this, (0, util_1.deepMix)({}, Scrollbar.defaultOptions, options)) || this;
        _this.range = [0, 1];
        /**
         * 值改变事件
         */
        _this.onValueChange = function (oldValue) {
            var newValue = _this.style.value;
    ...
    Object.defineProperty(Scrollbar.prototype, "padding", {
        get: function () {
            ...
            return (0, util_2.normalSeriesAttr)(padding);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(Scrollbar.prototype, "thumbRadius", {
        get: function () {
            var isRound = this.attributes.isRound;
            if (!isRound)
                return 0;
    ...
    Scrollbar.prototype.renderSlider = function (container) {
        var _a = this.attributes, orient = _a.orient, trackSize = _a.trackSize, padding = _a.padding, slidable = _a.slidable;
        var _b = tslib_1.__read((0, util_2.subObjects)(this.attributes, ['track', 'thumb']), 2), trackStyle = _b[0], selectionStyle = _b[1];
        var style = tslib_1.__assign(tslib_1.__assign({ orient: orient, padding: padding, slidable: slidable, trackSize: trackSize, brushable: false, showHandle: false, values: this.getValues(), trackLength: this.trackLength, trackRadius: this.trackRadius, selectionRadius: this.thumbRadius }, (0, util_2.superObject)(trackStyle, 'track')), (0, util_2.superObject)(selectionStyle, 'selection'));
