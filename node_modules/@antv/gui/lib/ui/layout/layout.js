...
var Layout = /** @class */ (function (_super) {
    ...
    function Layout(cfg) {
        ...
        _this.$margin = (0, series_1.normalSeriesAttr)(0);
        _this.$padding = (0, series_1.normalSeriesAttr)(0);
        var _a = cfg.style || {}, _b = _a.margin, margin = _b === void 0 ? 0 : _b, _c = _a.padding, padding = _c === void 0 ? 0 : _c;
        _this.margin = margin;
    ...
    Object.defineProperty(Layout.prototype, "margin", {
        ...
        set: function (value) {
            this.$margin = (0, series_1.normalSeriesAttr)(value);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Layout.prototype, "padding", {
        ...
        set: function (value) {
            this.$padding = (0, series_1.normalSeriesAttr)(value);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Layout.prototype.attributeChangedCallback = function (name, value, oldValue) {
        if (name === 'margin')
            this.margin = value;
