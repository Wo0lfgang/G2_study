...
var CategoryItem = /** @class */ (function (_super) {
    ...
    function CategoryItem(config) {
        return _super.call(this, (0, util_2.deepAssign)({}, { style: DEFAULT_ITEM_CFG }, config)) || this;
    }
    Object.defineProperty(CategoryItem.prototype, "showValue", {
        get: function () {
            ...
            if (!value)
                return false;
            if ((0, util_1.isString)(value) || (0, util_1.isNumber)(value))
                return value !== '';
    ...
    Object.defineProperty(CategoryItem.prototype, "span", {
        get: function () {
            ...
            var _a = tslib_1.__read((0, util_2.normalSeriesAttr)(span), 2), span1 = _a[0], innerSpan = _a[1];
    ...
    Object.defineProperty(CategoryItem.prototype, "spacing", {
        get: function () {
            ...
            if (!spacing)
                return [0, 0];
            var _a = tslib_1.__read((0, util_2.normalSeriesAttr)(spacing), 2), spacing1 = _a[0], spacing2 = _a[1];
            if (this.showValue)
    ...
    CategoryItem.prototype.renderMarker = function (container) {
        ...
        var style = (0, util_2.subObject)(this.attributes, 'marker');
        this.markerGroup = container.maybeAppendByClassName(CLASS_NAMES.markerGroup, 'g');
        (0, util_2.ifShow)(!!marker, this.markerGroup, function () {
            _this.markerGroup.maybeAppendByClassName(CLASS_NAMES.marker, marker).styles(style);
            (0, util_2.scaleToPixel)(_this.markerGroup.node(), markerSize, true);
        });
    };
    CategoryItem.prototype.renderLabel = function (container) {
        var label = this.attributes.label;
        var style = (0, util_2.subObject)(this.attributes, 'label');
        this.labelGroup = container.maybeAppendByClassName(CLASS_NAMES.labelGroup, 'g');
        this.labelGroup.maybeAppendByClassName(CLASS_NAMES.label, function () { return (0, util_2.renderExtDo)(label); }).styles(style);
    };
    CategoryItem.prototype.renderValue = function (container) {
        var _this = this;
        var value = this.attributes.value;
        var style = (0, util_2.subObject)(this.attributes, 'value');
        this.valueGroup = container.maybeAppendByClassName(CLASS_NAMES.valueGroup, 'g');
        (0, util_2.ifShow)(this.showValue, this.valueGroup, function () {
            _this.valueGroup.maybeAppendByClassName(CLASS_NAMES.value, function () { return (0, util_2.renderExtDo)(value); }).styles(style);
        });
    };
    CategoryItem.prototype.renderBackground = function (container) {
        var _a = this.shape, width = _a.width, height = _a.height;
        var style = (0, util_2.subObject)(this.attributes, 'background');
    ...
    CategoryItem.prototype.adjustLayout = function () {
        var _a = this.layout, markerWidth = _a.markerWidth, labelWidth = _a.labelWidth, valueWidth = _a.valueWidth, width = _a.width, height = _a.height, _b = tslib_1.__read(_a.position, 3), markerX = _b[0], labelX = _b[1], valueX = _b[2];
        var halfHeight = height / 2;
        this.markerGroup.styles({ x: markerX, y: halfHeight });
        this.labelGroup.styles({ x: labelX, y: halfHeight });
        (0, util_2.ellipsisIt)(this.labelGroup.select(CLASS_NAMES.label.class), labelWidth);
        if (this.showValue) {
            this.valueGroup.styles({ x: valueX, y: halfHeight });
            (0, util_2.ellipsisIt)(this.valueGroup.select(CLASS_NAMES.value.class), valueWidth);
        }
    };
    CategoryItem.prototype.render = function (attributes, container) {
        var ctn = (0, util_2.select)(container);
