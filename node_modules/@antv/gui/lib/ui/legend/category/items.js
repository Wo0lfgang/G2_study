...
var CategoryItems = /** @class */ (function (_super) {
    ...
    function CategoryItems(config) {
        var _this = _super.call(this, (0, util_2.deepAssign)({}, { style: CATEGORY_ITEMS_DEFAULT_CFG }, config)) || this;
    ...
    Object.defineProperty(CategoryItems.prototype, "renderData", {
        get: function () {
            ...
            var style = (0, util_2.subObject)(this.attributes, 'item');
            var d = data.map(function (datum, index) {
                var _a = datum.id, id = _a === void 0 ? index : _a, label = datum.label, value = datum.value;
                return {
                    id: "".concat(id),
                    index: index,
                    style: tslib_1.__assign({ layout: layout, label: label, value: value }, Object.fromEntries(Object.entries(style).map(function (_a) {
    ...
    CategoryItems.prototype.ifHorizontal = function (a, b) {
        ...
        return (0, utils_1.ifHorizontal)(orient, a, b);
    };
    ...
    CategoryItems.prototype.relayoutNavigator = function () {
        ...
        this.navigator.update(tslib_1.__assign({}, (layout === 'grid' ? { pageWidth: width - navWidth, pageHeight: height - navHeight } : {})));
    };
    CategoryItems.prototype.adjustLayout = function () {
        ...
        itemsLayouts.forEach(function (_a) {
            ...
            var page = _this.pageViews.appendChild(new g_1.Group({ className: CLASS_NAMES.page.name }));
    ...
    CategoryItems.prototype.renderNavigator = function (container) {
        var orient = this.attributes.orient;
        var navStyle = (0, util_2.subObject)(this.attributes, 'nav');
        var style = tslib_1.__assign(tslib_1.__assign({}, navStyle), { orient: orient });
        this.navigator = container
            .maybeAppendByClassName(CLASS_NAMES.navigator, function () { return new navigator_1.Navigator({}); })
            .update(style)
            .node();
