...
export type LegendBaseStyle = GroupStyleProps & PrefixedStyle<TitleStyleProps, 'title'> & PrefixedStyle<RectStyleProps, 'background'>;
...
export type ContinuousCfg = LegendBaseCfg & RibbonCfg & HandleCfg & LabelCfg & IndicatorCfg & {
