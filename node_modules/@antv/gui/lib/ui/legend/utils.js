...
exports.ifHorizontal = exports.getSafetySelections = exports.ifH = exports.horizontalHandle = exports.verticalHandle = exports.hiddenHandle = exports.getStepValueByValue = void 0;
...
function getSafetySelections(domain, newSelection, oldSelection, precision) {
    ...
    // 保留小数
    return [(0, util_1.toPrecision)(startVal, precision), (0, util_1.toPrecision)(endVal, precision)];
}
exports.getSafetySelections = getSafetySelections;
function ifHorizontal(orient, a, b) {
    if (orient === void 0) { orient = 'horizontal'; }
    return orient === 'horizontal' ? a : b;
}
