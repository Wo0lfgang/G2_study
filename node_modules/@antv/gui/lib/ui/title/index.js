...
function getBBox(title, content) {
    ...
    var _b = tslib_1.__read((0, util_1.normalSeriesAttr)(title.attributes.text ? spacing : 0), 4), spacingTop = _b[0], spacingRight = _b[1], spacingBottom = _b[2], spacingLeft = _b[3];
    var _c = tslib_1.__read((0, util_1.normalSeriesAttr)(inset), 4), insetTop = _c[0], insetRight = _c[1], insetBottom = _c[2], insetLeft = _c[3];
...
var Title = /** @class */ (function (_super) {
    ...
    function Title(options) {
        ...
        return _super.call(this, (0, util_1.deepAssign)({}, { style: DEFAULT_TITLE_CFG }, options)) || this;
    }
    Title.prototype.getAvailableSpace = function () {
        ...
        var _c = tslib_1.__read((0, util_1.normalSeriesAttr)(spacing), 4), spacingTop = _c[0], spacingRight = _c[1], spacingBottom = _c[2], spacingLeft = _c[3];
        ...
        var _e = tslib_1.__read((0, util_1.normalSeriesAttr)(inset), 4), insetTop = _e[0], insetRight = _e[1], insetBottom = _e[2], insetLeft = _e[3];
    ...
    Title.prototype.render = function (attributes, container) {
        var _this = this;
        var _a = attributes, width = _a.width, height = _a.height, position = _a.position, spacing = _a.spacing, className = _a.class, // remove class attr
        restStyle = tslib_1.__rest(_a, ["width", "height", "position", "spacing", "class"]);
        var _b = tslib_1.__read((0, util_1.styleSeparator)(restStyle), 1), titleStyle = _b[0];
        var _c = getTitleLayout(attributes), x = _c.x, y = _c.y, textAlign = _c.textAlign, textBaseline = _c.textBaseline;
        (0, util_1.ifShow)(!!restStyle.text, container, function (group) {
            _this.title = (0, util_1.select)(group)
