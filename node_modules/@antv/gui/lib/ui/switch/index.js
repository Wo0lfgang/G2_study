...
var Switch = /** @class */ (function (_super) {
    ...
    function Switch(options) {
        return _super.call(this, (0, util_1.deepMix)({}, Switch.defaultOptions, options)) || this;
    }
    Switch.prototype.render = function (attributes, container) {
        var _this = this;
        var _a = attributes.size, size = _a === void 0 ? 'default' : _a, spacing = attributes.spacing, disabled = attributes.disabled, checked = attributes.checked, unCheckedChildren = attributes.unCheckedChildren, checkedChildren = attributes.checkedChildren;
        var group = (0, util_2.select)(container).maybeAppendByClassName('switch-content', 'g').node();
        var bounds = group.getLocalBounds();
        var _b = (0, util_1.get)(constant_1.SIZE_STYLE, size, constant_1.SIZE_STYLE.default), sizeStyle = _b.sizeStyle, tagStyle = _b.tagStyle;
        // 其他统一属性
        ...
        if (checkedChildren || unCheckedChildren) {
            (0, util_2.select)(group)
                ...
                tagShape.update((0, util_1.deepMix)({
                    cursor: cursor,
