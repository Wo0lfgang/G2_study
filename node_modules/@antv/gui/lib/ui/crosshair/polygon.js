...
var PolygonCrosshair = /** @class */ (function (_super) {
    ...
    Object.defineProperty(PolygonCrosshair.prototype, "points", {
        ...
        get: function () {
            ...
            for (var i = 0; i < sides; i += 1) {
                points.push(matrix_util_1.vec2.rotate([0, 0], unit, [0, 0], (startAngle / 180) * Math.PI + a * i));
            }
            return points;
        },
        enumerable: false,
    ...
    PolygonCrosshair.prototype.createPolygonPath = function (radius) {
        ...
        var path = this.points.map(function (_a, index) {
            var _b = tslib_1.__read(_a, 2), x = _b[0], y = _b[1];
            var _c = tslib_1.__read(matrix_util_1.vec2.scale([0, 0], [x, y], radius || defaultRadius), 2), tx = _c[0], ty = _c[1];
    ...
    tslib_1.__decorate([
        (0, util_1.throttle)(20)
    ], PolygonCrosshair.prototype, "setPointer", null);
