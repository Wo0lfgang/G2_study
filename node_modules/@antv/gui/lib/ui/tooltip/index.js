...
var Tooltip = /** @class */ (function (_super) {
    ...
    function Tooltip(options) {
        var _this = _super.call(this, (0, util_1.deepMix)({}, Tooltip.defaultOptions, options)) || this;
    ...
    Object.defineProperty(Tooltip.prototype, "items", {
        get: function () {
            ...
            return items.map(function (_a, idx) {
                var _b = _a.name, name = _b === void 0 ? '' : _b, value = _a.value, _c = _a.color, color = _c === void 0 ? 'black' : _c, index = _a.index, rest = tslib_1.__rest(_a, ["name", "value", "color", "index"]);
                return tslib_1.__assign({ name: name, value: value, color: color, index: index !== null && index !== void 0 ? index : idx }, rest);
            });
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(Tooltip.prototype, "HTMLTooltipItemsElements", {
        get: function () {
            ...
            this.items.forEach(function (item) {
                itemsHTML.push((0, dom_util_1.createDom)((0, util_1.substitute)(template.item, item)));
            });
            return itemsHTML;
        },
        enumerable: false,
    ...
    Object.defineProperty(Tooltip.prototype, "customContent", {
        ...
        get: function () {
            ...
            if ((0, util_1.isString)(customContent))
                return (0, util_2.parseHTML)(customContent);
            if ((0, util_1.isElement)(customContent))
    ...
    Tooltip.prototype.renderHTMLTooltipElement = function () {
        ...
        if (customContent)
            ...
            ul_1.className = constant_1.CLASS_NAME.LIST;
