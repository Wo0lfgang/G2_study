...
var Breadcrumb = /** @class */ (function (_super) {
    ...
    Breadcrumb.prototype.render = function (attributes, container) {
        ...
        var _b = tslib_1.__read((0, util_2.normalSeriesAttr)(padding), 3), top = _b[0], right = _b[1], left = _b[2];
        ...
        var _loop_1 = function (i) {
            ...
            var shape = new tag_1.Tag({
                ...
                style: tslib_1.__assign(tslib_1.__assign({ x: cursorX, y: cursorY, text: (0, util_1.isNil)(datum.text) ? datum.id : datum.text, textStyle: textStyle }, (0, util_1.pick)(datum, ['marker'])), { 
                    // 强制不需要背景
                    padding: 0, backgroundStyle: null }),
            });
            ...
            // 最后一个分隔符，不需要渲染
            if (i !== items.length - 1) {
                var shape_1 = new g_1.Text({
                    className: "".concat(Breadcrumb.tag, "-separator"),
                    id: "".concat(Breadcrumb.tag, "-separator-").concat(i),
                    style: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, util_2.TEXT_INHERITABLE_PROPS), { x: cursorX + spacing, y: cursorY + shapeH / 2 }), style), { text: text, textAlign: 'end', textBaseline: 'middle' }),
                });
    ...
    Breadcrumb.defaultOptions = {
        style: {
            ...
            textStyle: {
                default: tslib_1.__assign(tslib_1.__assign({}, util_2.TEXT_INHERITABLE_PROPS), { fontSize: 14, fill: 'rgba(0, 0, 0, 0.45)' }),
                active: {
                    fill: '#5468ff',
                    cursor: 'pointer',
                },
