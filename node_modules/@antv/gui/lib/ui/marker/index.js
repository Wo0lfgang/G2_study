...
var Marker = /** @class */ (function (_super) {
    ...
    Marker.prototype.render = function (attributes, container) {
        var _a = attributes, x = _a.x, y = _a.y, symbol = _a.symbol, _b = _a.size, size = _b === void 0 ? 16 : _b, className = _a.class, style = tslib_1.__rest(_a, ["x", "y", "symbol", "size", "class"]);
        var type = getType(symbol);
        (0, util_2.ifShow)(!!type, (0, util_2.select)(container), function (group) {
            group
                .maybeAppendByClassName("marker", type)
                .addClassName("".concat(type, "-marker"))
                ...
                if (type === 'image') {
                    ...
                    // @ts-ignore
                    selection.styles(tslib_1.__assign({ path: symbolFn === null || symbolFn === void 0 ? void 0 : symbolFn(x, y, r) }, style));
                }
            });
        });
    };
