...
export type PrefixedStyle<T extends {
    [key: string]: any;
}, P extends string> = {
...
export type CallbackableObject<T extends {
    [keys: string]: any;
}, P extends any[]> = {
    [K in keyof T]: Callbackable<T[K], P>;
};
export type InferPrefixStyle<T> = T extends PrefixedStyle<infer P, any> ? P : never;
export type InferCallbackableStyle<T> = T extends CallbackableObject<PrefixedStyle<infer P, any>, infer Q> ? CallbackableObject<P, Q> : never;
