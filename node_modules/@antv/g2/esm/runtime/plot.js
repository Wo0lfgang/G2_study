...
function plotView(view, selection, transitions, library) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const componentsTransitions = selection
            ...
            .append((options) => renderComponent(deepMix({ animate: componentAnimateOptions }, options), coordinate, theme, library)), (update) => update.transition(function (options) {
            const { preserve = false } = options;
            if (preserve)
                return;
            const newComponent = renderComponent(deepMix({ animate: componentAnimateOptions }, options), coordinate, theme, library);
