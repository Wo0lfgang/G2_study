...
export const AxisRadar = (options) => {
    ...
    return (scales, value, coordinate, theme) => {
        return LinearAxis(Object.assign(Object.assign(Object.assign({}, restOptions), inferTitleTransform(options.orientation)), { important: Object.assign(Object.assign({}, inferAxisStyle(options, theme, coordinate, value)), important) }))(scales, value, coordinate, theme);
    };
};
