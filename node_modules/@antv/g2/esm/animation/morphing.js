...
function shapeToShape(from, to, timeEffect) {
    ...
    const sy = h0 / h1;
    const keyframes = [
        Object.assign({ transform: `translate(${dx}, ${dy}) scale(${sx}, ${sy})` }, attributeOf(from, attributeKeys)),
        Object.assign({ transform: `translate(0, 0) scale(1, 1)` }, attributeOf(to, attributeKeys)),
    ];
