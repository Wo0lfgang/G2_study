...
import { createValueof, createDatumof, selectG2Elements, useState, renderLink, renderBackground, selectPlotArea, mergeState, offsetTransform, } from './utils';
/**
...
scale, coordinate, state = {}, }) {
    ...
    const [appendBackground, removeBackground, isBackground] = renderBackground(Object.assign({ scale,
        coordinate,
        background,
