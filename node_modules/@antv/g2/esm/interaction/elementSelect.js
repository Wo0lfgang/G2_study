...
import { createValueof, createDatumof, selectG2Elements, useState, renderLink, renderBackground, selectPlotArea, offsetTransform, mergeState, } from './utils';
/**
...
coordinate, background = false, scale, state = {}, }) {
    var _a;
    ...
    const [appendBackground, removeBackground] = renderBackground(Object.assign({ background,
        coordinate,
        scale,
