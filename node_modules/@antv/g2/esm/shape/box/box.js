...
export const Box = (options) => {
    ...
    return (points, value, coordinate, theme) => {
        ...
        const _a = getShapeTheme(theme, mark, shape, defaultShape), { defaultColor, fill = defaultColor, stroke = defaultColor } = _a, shapeTheme = __rest(_a, ["defaultColor", "fill", "stroke"]);
