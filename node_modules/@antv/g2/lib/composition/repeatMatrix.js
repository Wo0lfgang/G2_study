    ...
    const createChildren = (visualData, scale, layout) => {
        ...
        return index.flatMap((i) => {
            ...
            return children.map((d) => {
                var _a, _b;
                const { scale, key, encode, axis } = d, rest = __rest(d, ["scale", "key", "encode", "axis"]);
                ...
                return Object.assign({ data, parentKey: viewKey, key: `${key}-${i}`, x: left + paddingLeft + originX, y: top + paddingTop + originY, width,
                    height, paddingLeft: 0, paddingRight: 0, paddingTop: 0, paddingBottom: 0, frame: true, scale: (0, util_1.deepMix)(defaultScale, scale), axis: (0, util_1.deepMix)(defaultAxis, axis, newAxis), 
