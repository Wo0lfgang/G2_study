...
exports.isValidScale = exports.isPosition = exports.syncFacetsScales = exports.useRelationScale = exports.useRelation = exports.applyScale = exports.inferScale = void 0;
...
function inferScale(name, values, options, coordinates, theme, library) {
    ...
    return Object.assign(Object.assign(Object.assign({}, options), inferScaleOptions(type, name, values, options, coordinates)), { domain, range: inferScaleRange(type, name, values, options, domain, theme, library), guide,
        name,
        type });
}
...
function inferOptionsQ(coordinates, options) {
    const { interpolate = scale_1.createInterpolateValue, nice = false, tickCount = 10, } = options;
