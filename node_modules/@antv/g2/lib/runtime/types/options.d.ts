...
import { G2Title, G2ViewDescriptor, GuideComponentPosition, Layout, Primitive } from './common';
import { AdjustComponent, AnimationComponent, CompositionComponent, CoordinateComponent, G2BaseComponent, G2ComponentNamespaces, GuideComponentComponent, InferComponent, InteractionComponent, LabelTransformComponent, PaletteComponent, Scale, ScaleComponent, ShapeComponent, StatisticComponent, ThemeComponent } from './component';
...
export type G2Library = Record<`${G2ComponentNamespaces}.${string}`, G2BaseComponent>;
...
export type G2MarkChildrenCallback = (visualData: Record<string, any>[], scale: Record<string, Scale>, layout: Layout) => Node[];
export type G2BaseComponentOptions<C = G2BaseComponent, O = {
    [key: string | symbol]: any;
}> = {
    type?: string | C;
} & O;
export type G2ComponentOptions = G2TransformOptions | G2StatisticOptions | G2EncodeOptions | G2ThemeOptions | G2MarkOptions | G2CoordinateOptions | G2ScaleOptions | G2InferOptions | G2ShapeOptions | G2PaletteOptions | G2GuideComponentOptions | G2AnimationOptions | G2InteractionOptions | G2CompositionOptions | G2AdjustOptions | G2LabelTransformOptions;
...
export type G2ScaleOptions = G2BaseComponentOptions<ScaleComponent, {
    name?: string;
    domain?: any[];
    range?: any[];
...
export type G2GuideComponentOptions = G2BaseComponentOptions<GuideComponentComponent, {
...
export type G2LabelTransformOptions = G2BaseComponentOptions<LabelTransformComponent>;
