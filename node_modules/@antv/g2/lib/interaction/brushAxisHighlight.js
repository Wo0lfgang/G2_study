...
function brushAxisHighlight(root, _a) {
    ...
    reverse = false, state = {} } = _a, rest = __rest(_a, ["axes", "elements", "points", "horizontal", "datum", "offsetY", "offsetX", "reverse", "state"]) // style
    ;
    const elements = elementsOf(root);
    const axes = axesOf(root);
    const valueof = (0, utils_1.createValueof)(elements, datum);
    const { setState } = (0, utils_1.useState)(state, valueof);
    ...
    for (const axis of axes) {
        ...
        (0, brushHighlight_1.brush)(hotZone, Object.assign(Object.assign({}, brushStyle), { reverse,
            brushRegion,
            brushended() {
