...
const WordCloud = (options) => {
    return (viewOptions) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const transformData = yield (0, data_1.WordCloud)(Object.assign(Object.assign({}, DEFAULT_LAYOUT_OPTIONS), layout))(initializedData);
        return [
            (0, util_1.deepMix)({}, DEFAULT_OPTIONS, Object.assign(Object.assign({ data: transformData, encode,
                scale,
