...
const Treemap = (options) => {
    return (viewOptions) => {
        ...
        const { data, encode = {}, scale, style = {}, layout = {}, labels = [] } = options, resOptions = __rest(options, ["data", "encode", "scale", "style", "layout", "labels"]);
        ...
        const transformedData = dataTransform(data, (0, util_1.deepMix)({}, DEFAULT_LAYOUT_OPTIONS, layout), encode);
