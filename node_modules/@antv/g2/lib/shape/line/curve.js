...
const DoublePath = (0, createElement_1.createElement)((g) => {
    ...
    (0, selection_1.select)(g)
        .maybeAppend('line', () => new g_1.Path({}))
        .style('d', d1)
        .call(utils_1.applyStyle, style1);
    (0, selection_1.select)(g)
        .maybeAppend('line1', () => new g_1.Path({}))
        .style('d', d2)
...
const Curve = (options) => {
    ...
    return (P, value, coordinate, theme) => {
        ...
        const _a = (0, utils_1.getShapeTheme)(theme, mark, shape, defaultShape), { defaultColor, lineWidth: defaultSize } = _a, defaults = __rest(_a, ["defaultColor", "lineWidth"]);
        const { color = defaultColor, size = defaultSize, seriesColor: sc, seriesX: sx, seriesY: sy, } = value;
        const stroke = gradient && sc
            ? (0, utils_1.computeGradient)(sc, sx, sy, gradient, gradientColor)
            : color;
