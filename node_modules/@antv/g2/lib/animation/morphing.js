...
function shapeToShape(from, to, timeEffect) {
    ...
    const sy = h0 / h1;
    const keyframes = [
        Object.assign({ transform: `translate(${dx}, ${dy}) scale(${sx}, ${sy})` }, (0, utils_1.attributeOf)(from, utils_1.attributeKeys)),
        Object.assign({ transform: `translate(0, 0) scale(1, 1)` }, (0, utils_1.attributeOf)(to, utils_1.attributeKeys)),
    ];
