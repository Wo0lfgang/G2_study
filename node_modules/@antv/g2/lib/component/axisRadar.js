...
function inferAxisStyle(options, theme, coordinate, value) {
    const { radar } = options;
    const { scales: [{ name }], } = value;
    const [startAngle, endAngle] = (0, coordinate_1.angleOf)(coordinate);
    const { axisRadar: radarTheme = {} } = theme;
    return Object.assign(Object.assign({}, radarTheme), { showGrid: name === 'position', gridConnect: 'line', gridControlAngles: new Array(radar.count).fill(0).map((_, i) => {
...
const AxisRadar = (options) => {
    ...
    return (scales, value, coordinate, theme) => {
        return (0, axis_1.LinearAxis)(Object.assign(Object.assign(Object.assign({}, restOptions), inferTitleTransform(options.orientation)), { important: Object.assign(Object.assign({}, inferAxisStyle(options, theme, coordinate, value)), important) }))(scales, value, coordinate, theme);
    };
};
