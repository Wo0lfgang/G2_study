...
const ArcAxisComponent = (options) => {
    ...
    return ([scale], value, coordinate, theme) => {
        ...
        return new gui_1.Axis({
            style: (0, util_1.deepMix)({}, axisTheme, defaultStyle, Object.assign(Object.assign({ type: 'arc', data: ticks, title: (0, utils_1.titleContent)(title), showGrid }, rest), important)),
        });
    };
};
...
const LinearAxisComponent = (options) => {
    ...
    return ([scale], value, coordinate, theme) => {
        ...
        const axisStyle = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, defaultStyle), style), { type: 'linear', data: ticks, title: (0, utils_1.titleContent)(title), showLabel, labelTransforms: labelTransforms(labelAutoHide, labelAutoRotate), showGrid,
            showTick,
...
const axisFactor = (axis) => {
    return (options) => {
        ...
        const labelFormatter = typeof f === 'string' ? (0, d3_format_1.format)(f) : f;
