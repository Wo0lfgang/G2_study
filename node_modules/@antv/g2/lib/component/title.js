...
const Title = (0, utils_2.createComponent)({
    render(attributes, container) {
        const { x, y, width, title, subtitle, spacing = 2, align = 'left', style, } = attributes;
        ...
        const mainTitle = (0, utils_2.maybeAppend)(container, '.title', 'text')
            ...
            .call(utils_1.applyStyle, Object.assign(Object.assign(Object.assign({}, inferStyleByAlign(0, y, width, align)), { fontSize: 14, textBaseline: 'top', text: title }), titleStyle))
            .node();
