...
export type PointInPathPicker<T extends BaseStyleProps> = (displayObject: DisplayObject<T>, point: Point, isClipPath?: boolean, isPointInPath?: (runtime: GlobalRuntime, displayObject: DisplayObject<T>, point: Point) => boolean, runtime?: GlobalRuntime) => boolean;
/**
...
export declare class CanvasPickerPlugin implements RenderingPlugin {
    ...
    private pointInPathPickerFactory;
